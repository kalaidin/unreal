# coding: utf-8
"""
created by artemkorkhov at 2017/01/25
"""
...
from train.trainer import Trainer, SubmitTrainer
...
def make_submit(executor):
    """ Makes submit """
    executor.process(sess, global_t, summary_writer, summary_op, score_input)
...
#     t.start()
make_submit(executor=submitter)
